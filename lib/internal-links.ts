...
const curatedLinks: Record<string, string[]> = {
  ...
  "moving-cleaning-guide": ["bathroom-tile-grout-repair-guide", "move-in-first-day-essentials", "moving-day-checklist", "easy-interior-ideas-for-beginners", "moving-with-pets", "moving-preparation-checklist", "wallpaper-flooring-move-in-cleaning-order"],
  "rental-deposit-moving-out-checklist": ["moving-company-quote-comparison", "moving-day-checklist", "moving-cleaning-guide", "move-in-report-address-change", "easy-interior-ideas-for-beginners", "curtain-blind-installation-cost"],
  ...
  "easy-interior-ideas-for-beginners": ["moving-cleaning-guide", "rental-deposit-moving-out-checklist", "moving-day-checklist", "moving-preparation-checklist", "moving-with-pets", "curtain-blind-installation-cost", "post-move-organizing-service-cost"],
  ...
  "air-conditioner-moving-installation-cost": ["packing-moving-cost-factors", "moving-company-quote-comparison", "moving-ladder-truck-cost-guide", "elevator-moving-cost-conditions", "wall-mounted-tv-moving-installation-cost", "washer-dryer-moving-installation-cost", "dishwasher-moving-installation-cost"],
  "washer-dryer-moving-installation-cost": ["air-conditioner-moving-installation-cost", "moving-day-checklist", "packing-moving-cost-factors", "home-repair-plumbing-estimate-guide", "moving-company-quote-comparison", "move-in-first-day-essentials", "dishwasher-moving-installation-cost"],
  ...
  "post-move-organizing-service-cost": ["moving-cleaning-guide", "move-in-first-day-essentials", "easy-interior-ideas-for-beginners", "moving-box-quantity-size-guide"],
  "dishwasher-moving-installation-cost": ["washer-dryer-moving-installation-cost", "air-conditioner-moving-installation-cost", "packing-moving-cost-factors", "home-repair-plumbing-estimate-guide", "rental-deposit-moving-out-checklist"],
  "wallpaper-flooring-move-in-cleaning-order": ["moving-cleaning-guide", "easy-interior-ideas-for-beginners", "moving-preparation-checklist", "move-in-first-day-essentials"],
  "moving-box-quantity-size-guide": ["studio-moving-service-comparison", "move-in-first-day-essentials", "moving-preparation-checklist", "packing-moving-cost-factors", "moving-day-checklist", "post-move-organizing-service-cost"],
