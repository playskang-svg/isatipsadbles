...
const curatedLinks: Record<string, string[]> = {
  ...
  "curtain-blind-installation-cost": ["rental-deposit-moving-out-checklist", "easy-interior-ideas-for-beginners", "no-drill-wall-mounted-tv-installation", "move-in-first-day-essentials", "moving-cleaning-guide"],
