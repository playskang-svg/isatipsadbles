...
const curatedLinks: Record<string, string[]> = {
  ...
  "air-conditioner-moving-installation-cost": ["packing-moving-cost-factors", "moving-company-quote-comparison", "moving-ladder-truck-cost-guide", "elevator-moving-cost-conditions", "wall-mounted-tv-moving-installation-cost"],
